...
class NetworkManager: NetworkServicing {
    ...
    func updateProductInAPI(endpoint: any Endpoint, productId: Int, updatedProduct: updatedProductRequest, completionHandler: @escaping (Result<Bool, any Error>) -> Void) {
